...
def obj_detection():
    ...
    st.subheader("This module takes the input as image and outputs the image with detected objects with their confidence score.")
...
app_mode = st.sidebar.selectbox("Choose the app mode",
        ["Home","Object detection-Images","Real Time Detection","Work Flow"])
